    ...
    <v-app>
        ...
        <div id="app" class="container">
            <card data-image="https://images.unsplash.com/photo-1479660656269-197ebb83b540?dpr=2&auto=compress,format&fit=crop&w=1199&h=798&q=80&cs=tinysrgb&crop=">
                ...
                <p slot="content">Lorem olor sit amet, consectetur adipisicing elit.</p>
            </card>
            ...
            <v-card >
                <v-img
                    ...
                    height="200px"
                    src="https://images.unsplash.com/photo-1479621051492-5a6f9bd9e51a?dpr=2&auto=compress,format&fit=crop&w=1199&h=811&q=80&cs=tinysrgb&crop=">
                </v-img>
            </v-card>
        </div>
